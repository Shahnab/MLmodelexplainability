...
def main():
    ...
    html_txt1 = """
        ### Compatability with sklearn models only
    """
    html_txt2 = """<font color='red'>Upload files to Explain</font>"""
    ...
    option = st.sidebar.selectbox('Explainability', ('ML Explain',))
    ...
    if option == 'Glossary':
        ...
        demo_explain = st.sidebar.checkbox('Click on checkbox for App demo with custom dataset')
        ...
        # Upload required data and model to explain
            ...
            if which_ml_model == 'Classification':
                ...
                selected_explain = st.radio('Select Explainability Parameters:', radio_option)
                ...
                # Display all plot
                    ...
                    st.write('Selection for Model Explainability')
